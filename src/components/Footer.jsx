        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-10">
          ...
          <motion.div {...fadeUp}>
            <Link to="/" className="inline-block mb-3">
              <img src="/logo.png" alt="RunResult Logo" className="h-10 w-auto brightness-0 invert" />
            </Link>
            ...
            <div className="flex items-center gap-2.5">
              {socialLinks.map(({ Icon, href, label }) => (
                <a
                  ...
                  href={href}
                  aria-label={label}
                  className="w-8 h-8 rounded-full bg-white/10 border border-white/15 flex items-center justify-center text-white/60 hover:bg-white hover:text-[#0342B3] transition-all duration-300"
                >
                  <Icon />
                </a>
              ))}
          ...
          {/* Contact */}
          <motion.div {...fadeUp} transition={{ ...fadeUp.transition, delay: 0.2 }} className="flex flex-col justify-center">
            <h3 className="text-xs font-bold uppercase tracking-widest text-white/40 mb-4">Contact</h3>
            <ul className="space-y-3">
              ...
              <li>
                <a href="mailto:runresults700@gmail.com" className="flex items-center gap-3 group">
                  <div className="w-7 h-7 rounded-lg bg-white/10 border border-white/10 flex items-center justify-center shrink-0 group-hover:bg-white/20 transition-colors">
                    <Mail size={13} className="text-white/70" />
                  </div>
                  <p className="text-sm text-white/80 group-hover:text-white transition-colors">runresults700@gmail.com</p>
                </a>
              </li>
              <li>
                <a href="tel:+94760347594" className="flex items-center gap-3 group">
                  <div className="w-7 h-7 rounded-lg bg-white/10 border border-white/10 flex items-center justify-center shrink-0 group-hover:bg-white/20 transition-colors">
